...
<!-- 20230709 | MESGR-2750 | SPEC-EN004-IW3-V0.1 LOIPRO - Filter out leading zeros in material number -->
<xsl:stylesheet version="2.0"
    ...
    <xsl:template match="/LOIPRO04/IDOC">
    ...
    <xsl:template match="/LOIPRO04/IDOC/E1AFKOL">
        <ManufacturingOrder>
            <ManufacturingOrder>
    ...
    <xsl:template match="/LOIPRO04/IDOC/E1AFKOL/E1AFFLL">
                ...
                <pp:StandardWorkFormulaParamGroup StandardWorkFormulaParamGroupID="{VGWTS}">
                    <xsl:if test="VGE01 != ''">
                        <WorkCenterFormulaParam1 WorkCenterFormulaParamID="">
                            ...
                            <ToBeConfirmedTotalWorkQty pp:unitCode=""/>
        ...
        <xsl:for-each select="E1AFVOL[E1JSTVL[last()]/STAT!='I0013']">
            ...
            <xsl:choose>
                <xsl:when test="position() = 1">
                    ...
                    <ManufacturingOrderRelationship>
                        ...
                        <PredecessorMfgOrderNodeID>
                            <xsl:value-of select="concat(//LOIPRO04/IDOC/E1AFKOL/AUFNR, 'SEVT')"/>
                        </PredecessorMfgOrderNodeID>
                ...
                <xsl:otherwise>
                    <ManufacturingOrderRelationship>
                        ...
                        <PredecessorMfgOrderNodeID>
                            <xsl:call-template name="calcNodeId">
                                <xsl:with-param name="actNum" select="preceding-sibling::E1AFVOL[1]/VORNR"/>
                                <xsl:with-param name="superOpNum" select="preceding-sibling::E1AFVOL[1]/PVZNR"/>
                            </xsl:call-template>
                        </PredecessorMfgOrderNodeID>
                        <SuccessorMfgOrderNodeType>Operation</SuccessorMfgOrderNodeType>
                        <SuccessorMfgOrderNodeID>
            ...
            <xsl:if test="position() = last()">
                ...
                <ManufacturingOrderRelationship>
                    ...
                    <SuccessorMfgOrderNodeID>
                        <xsl:value-of select="concat(//LOIPRO04/IDOC/E1AFKOL/AUFNR, 'EEVT')"/>
                    </SuccessorMfgOrderNodeID>
                    <NetworkActivityRelationType>SucRel</NetworkActivityRelationType>
                </ManufacturingOrderRelationship>
            </xsl:if>
    ...
    <xsl:template match="/LOIPRO04/IDOC/E1AFKOL/E1VCCHR">
    ...
    <xsl:template name="calcNodeType">
        ...
        <xsl:choose>
            <xsl:when test="$superOpNum != ''"> <!-- has superordinate operation -->
                <xsl:value-of select="'SubOperation'"/> <!-- not supported yet -->
            </xsl:when>
            <xsl:otherwise>
    ...
    <xsl:template name="calcNodeId">
        ...
        <xsl:choose>
            <xsl:when test="$superOpNum != ''"> <!-- has superordinate operation -->
                <xsl:value-of select="concat('SUBOP',$actNum)"/> <!-- not supported yet -->
            </xsl:when>
            <xsl:otherwise>
    ...
    <xsl:template name="getMaterial">
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <xsl:value-of select="format-number(number($materialNumber), '#')"/>
            </xsl:otherwise>
        </xsl:choose>
    </xsl:template>
