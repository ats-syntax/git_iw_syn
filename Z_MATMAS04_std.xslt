...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="/">
        <xsl:apply-templates select="/Z_MATMAS04/IDOC/E1MARAM/E1MARCM"/>
    </xsl:template>
    <xsl:template match="/Z_MATMAS04/IDOC/E1MARAM/E1MARCM">
        <materialIn>
    ...
    <xsl:template name="getBusinessSystem">
        <xsl:value-of select="/Z_MATMAS04/IDOC/EDI_DC40/SNDPRN"/>
    </xsl:template>
</xsl:stylesheet>
